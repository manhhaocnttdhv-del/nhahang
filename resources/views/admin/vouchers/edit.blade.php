                ...
                <div class="card-body">
                    <form action="{{ route('admin.vouchers.update', $voucher->id) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="form-text text-muted" id="valueHint">
                                        {{ $voucher->type === 'percentage' ? 'Nhập phần trăm giảm (0-100)' : 'Nhập số tiền giảm (VNĐ)' }}
                                    </small>
                                    @error('value')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="min_order_amount" class="form-control @error('min_order_amount') is-invalid @enderror" 
                                           value="{{ old('min_order_amount', $voucher->min_order_amount) }}" min="0" step="1000">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Đã sử dụng: {{ $voucher->used_count }} lần. Để trống nếu không giới hạn.</small>
                            @error('usage_limit')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
